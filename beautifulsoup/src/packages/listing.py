...
def extract_listing(url):
    ...
    if request_success:
        companyName, company_starRating, company_offeredRole, company_roleLocation, Salary = extract_listingBanner(listing_soup)
        JobType, JobFunction, Industry, Size = extract_listingInsights(listing_soup)
        listing_jobDesc = extract_listingDesc(listing_soup)

        return (companyName, company_starRating, company_offeredRole, company_roleLocation, Salary, JobType, JobFunction, Industry, Size, listing_jobDesc, requested_url)
