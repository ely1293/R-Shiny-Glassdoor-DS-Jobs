...
if __name__ == "__main__":
    ...
    csv_header = [("companyName", "company_starRating", "company_offeredRole", "company_roleLocation", "Salary", "JobType", "JobFunction", "Industry", "Size", "listing_jobDesc", "requested_url")]
